...
pie_loop_start:
    ...
    ee.vadds.s16 q0, q0, q4     # 对q0和q4中的16位元素进行加法操作，结果存回q0
    ee.vadds.s16 q1, q1, q5     # 对q1和q5中的16位元素进行加法操作，结果存回q1
    ee.vadds.s16 q2, q2, q6     # 对q2和q6中的16位元素进行加法操作，结果存回q2
    ee.vadds.s16 q3, q3, q7     # 对q3和q7中的16位元素进行加法操作，结果存回q3
